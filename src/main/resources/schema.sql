...
create
unique index brokers_id_uindex
	on brokers (id);
...
create
unique index carriers_id_uindex
	on carriers (id);
...
create
unique index address_id_uindex
	on address (id);
...
create
unique index privilege_id_uindex
	on privilege (id);
...
create
unique index password_reset_tokens_id_uindex
...
create
unique index clients_id_uindex
...
create
unique index brokers_staging_id_uindex
